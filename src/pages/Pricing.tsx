...
const faqs = [
  ...
  },
  {
    ...
    answer: "Sim! Oferecemos 15% de desconto para pagamentos anuais em qualquer um dos nossos planos. Selecione 'Anual' acima para ver os preços com desconto."
  },
  {
...
const Pricing = () => {
  ...
  const plans = BASE_PLANS.map(plan => ({
    ...plan,
    price: String(getDisplayPrice(plan.monthlyPrice)),
      ...
      <main className="flex-grow">
        ...
        <section className="bg-secondary py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="inline-flex items-center justify-center bg-white rounded-full p-1 border shadow-sm mb-4">
              <button
                className={`px-5 py-2 rounded-full text-sm font-medium transition-colors ${
                  !isAnnual ? 'bg-primary text-white shadow' : 'text-gray-600 hover:text-gray-900'
                }`}
              ...
              <table className="min-w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-gray-200">
                    ...
                    {["Básico", "Profissional", "Premium"].map(p => (
                  ...
                  <tr className="border-b border-gray-200 bg-gray-50">
                    ...
                    <td className="py-4 px-6 text-center"><X size={16} className="mx-auto text-gray-400" /></td>
                    <td className="py-4 px-6 text-center"><Check size={16} className="mx-auto text-accent" /></td>
                    <td className="py-4 px-6 text-center"><Check size={16} className="mx-auto text-accent" /></td>
                  </tr>
                  <tr className="border-b border-gray-200">
